# -*- coding: utf-8 -*-
{
    ...
    'summary': """
        Purchase, Stock and Cash Requisitions for V16""",
    ...
    'data': [
        ...
        'purchase_requisition/views/po_requisition_view.xml',
        'purchase_requisition/views/menus.xml',
        'views/menus.xml',
    ],
}
